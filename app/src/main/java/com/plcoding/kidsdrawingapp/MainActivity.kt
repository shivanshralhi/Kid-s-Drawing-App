...
class MainActivity : AppCompatActivity() {
            ...
            permissions.entries.forEach{
                ...
                if(isGranted){
                   ...
                   if(permissionName==Manifest.permission.READ_MEDIA_IMAGES){
                       Toast.makeText(this,"Permission denied  you can not read storage files",Toast.LENGTH_LONG).show()
                   }
    ...
    private fun requestStoragePermission(){
            ...
            if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                showRationaleDialog("Kids Drawing App","Kids Drawing App"+"needs to access storage")
            }else{
                Log.d("PermissionRequest", "Requesting permission")
        ...
        withContext(Dispatchers.IO){
            if(mBitmap!=null){
                try{
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString() + File.separator+"Kids drawing_"+System.currentTimeMillis()/1000+".png")
